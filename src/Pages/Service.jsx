        ...
        <section className='w-full flex flex-col justify-center bg-slate-50 '>
            <div className='max-w-screen-2xl mx-auto mt-8'>
                <div className='text-center'>
                    ...
                    <p className='py-5 mb-10 px-10 md:px-32 text-4xl font-bold text-green-700'>We now offer online certificates. <br /> You can now easily request a certificate online, making the process faster and more convenient.</p>
                </div>
                ...
                <div className='flex flex-col md:flex-row flex-wrap justify-center gap-5 mb-10'>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            ...
                            <div className='flex flex-col w-full items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Barangay Clearance</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            ...
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Certificate of Residency</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Certificate of Indigency</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Certificate For Solo Parent</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Business Clearance</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Guardianship</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>First Time Job Seeker</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Common Law</p>
                    ...
                    <NavLink
                        ...
                        <div className='flex flex-col md:flex-row w-full h-fit justify-center md:justify-start items-center md:items-start'>
                            <img src={barangayLogo} alt='' className='h-24 mb-4 md:mb-0 md:mr-4' />
                            <div className='flex flex-col items-center md:items-start text-center md:text-left'>
                                <p className='font-semibold text-green-700'>Travel Permit</p>
