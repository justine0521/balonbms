...
function CertificateOfNoProperty() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (fullName === '') {
      ...
      const formData = {
        certificateType: 'Certificate Of No Property',
        certId: '7',
        fullName,
        email,
        contactNumber,
      ...
      <div className='px-5 h-fit flex justify-center flex-wrap gap-10'>
        <div className='w-96 h-fit mt-5 p-5 shadow-lg '>
          ...
          <div className='my-3 text-gray-600'>
            <p>A Certificate of No Property is an official document issued by a local government unit, typically the barangay, to certify that a specific individual does not own any real estate or property within the jurisdiction of the issuing authority</p>
          </div>
...
export default CertificateOfNoProperty;
