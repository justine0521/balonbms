      ...
      {isAnnouncement && (
        <div className='flex flex-wrap justify-center gap-10 h-fit m-8 mx-10'>
          <div className='flex flex-wrap md:flex-nowrap justify-center relative rounded shadow-xl drop-shadow-xl'>
            <img src={Hotspring} alt="Hotspring" className='w-full md:w-96 h-56 object-fit rounded-t-lg md:rounded-r-none md:rounded-l-lg' />

            <div className='w-full md:w-[450px] px-5 mt-5'>
          ...
          <div className='flex flex-wrap md:flex-nowrap justify-center relative rounded shadow-xl drop-shadow-xl'>
            ...
            <div className='w-full md:w-[450px] px-5 mt-5'>
              <h1 className='text-lg text-green-500 font-semibold'>Road Repair Advisory</h1>
