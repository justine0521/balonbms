  ...
  return (
    <footer className="bg-green-100 text-gray-600 py-10">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        {/* Links Section */}
        <div>
          <h3 className="text-xl text-green-500 font-semibold mb-4 mt-4 lg:mt-0">Quick Links</h3>
        ...
        {/* Community Section */}
        <div>
          <h3 className="text-xl text-green-500 font-semibold mb-4 mt-4 lg:mt-0">Community</h3>
          <ul className="space-y-2">
        ...
        {/* Contact Section */}
        <div>
          <h3 className="text-xl text-green-500 font-semibold mb-4 mt-4 lg:mt-0">Contact Us</h3>
          <ul className="space-y-2">
