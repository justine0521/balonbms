...
import BarangayClearance from '../Images/Certificate-Picture/Death Certificate-1.png'
import '../App.css';
      ...
      <div className='px-5 h-fit flex justify-center flex-wrap gap-10'>
        <div className='w-96 h-fit mt-5 p-5 shadow-lg '>
          ...
          <div className='my-3 text-gray-600'>
            <p>A Death Certificate is an official document setting forth particulars relating to a dead person, including the name of the individual, the date of birth and the date of death.</p>
          </div>
