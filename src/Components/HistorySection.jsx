  ...
  return (
    <div className="bg-white p-4 lg:mr-10 lg:flex lg:items-center lg:gap-10 mb-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
            <h1 className="text-green-500 text-2xl font-semibold">History</h1>
                <p className="text-sm">
                ...
                <div className="inline-block">
                    <button className="mt-2 bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700 transition duration-200 w-auto">
                        More Details
                    </button>
                </div>
