        ...
        <div className="">
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row-reverse lg:items-center lg:gap-10 flex flex-col border-b-1">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Community Health Initiatives</h1>
                    <p>
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row lg:items-center lg:gap-10 flex flex-col border-b-1">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Infrastructure Improvements</h1>
                    <p>
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row-reverse lg:items-center lg:gap-10 flex flex-col border-b-1">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Disaster Preparedness Programs</h1>
                    <p>
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row lg:items-center lg:gap-10 flex flex-col border-b-1">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Environmental Sustainability Efforts</h1>
                    <p>
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row-reverse lg:items-center lg:gap-10 flex flex-col border-b-1">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Youth Engagement Programs</h1>
                    <p>
            ...
            <div className="bg-white p-4 lg:mr-10 lg:flex lg:flex-row lg:items-center lg:gap-10 flex flex-col">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8 mt-8 lg:mt-0">
                    <h1 className="text-green-700 text-2xl font-semibold">Recognition Awards</h1>
                    <p>
